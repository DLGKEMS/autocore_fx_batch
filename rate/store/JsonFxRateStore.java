...
public class JsonFxRateStore implements FxRateStore {
    ...
    public JsonFxRateStore(ObjectMapper objectMapper, @Value("${fxrates.dir:rates}") String baseDir) {
    ...
    public void save(DailyFxRates daily) {
        if (daily == null) throw new IllegalArgumentException("daily = null");

        LocalDate date = daily.getPostingDate();
        if (date == null) throw new IllegalArgumentException("postingDate = null");
