package com.hakjin.autocore.processing.startup;
...
public class BatchStartupRunner implements CommandLineRunner {
    ...
    public BatchStartupRunner(FileJobFacade fileJobFacade, @Value("${app.dir_in}") String dirIn) {
            ...
            while (true) {
                ...
                for (WatchEvent<?> event : key.pollEvents()) {
                    ...
                    if (kind == StandardWatchEventKinds.ENTRY_CREATE) {
                        ...
                        System.out.println("새 파일 감지: " + createdFile);
                        // CSV만 처리
